...
var Span = require("tns-core-modules/text/span");
...
var Common = (function (_super) {
    ...
    Common.prototype.init = function () {
        ...
        if (this.render == "tags") {
            ...
            // this.formattedString = new formatted_string_1.FormattedString();
            // this.formattedString.col = "2";
            // let span = new Span.Span();
            // span.class = "lnr";
            // // span.text = {decode:"&#xe834;"};
            // span.text = "test";
            // this.formattedString.spans.push(span);
            ...
            // this.addChild(this.formattedString);
        }
    ...
    Common.prototype.closeModal = function () {
        if (this.isFunction(this.closeCallback)) {
            this.closeCallback();
            this.notify({
                eventName: Common_1.closeEvent,
                object: this,
                selected: this.selected_items
            });
            this.modalPage = new page_1.Page();
        }
    };
    ...
    Common.prototype.updateLabel = function (updatedLabel) {
        if (!this.labelselect) {
            return;
        }
        var self = this;
        this.labelselect.text = updatedLabel;
    };
    ...
    Common.prototype.refresh = function (option = null, updatedLabel = null) {
        if (this.render == "tags")
            this.tagsDone();
        else if (this.render == "label" || this.render == "drop")
            if (option == "updateLabel" && updatedLabel) {
    ...
    Common.prototype.doneSelect = function () {
        ...
        if (self.multiple == true)
            self.notify({
                eventName: Common_1.changeEvent,
                object: self,
    ...
    Common.prototype.onSubmit = function () {
        ...
        new Promise(function (resolve, reject) {
            ...
            self.notify({
                object: _this,
                eventName: Common_1.textChangeEvent,
                value: self.term
            })
            _this.listnToSearch();
        })
    ...
    Common.textChangeEvent = "textChange";
    Common.closeEvent = "close";
    Common = Common_1 = __decorate([
        layout_base_1.CSSType("FilterSelect"),
